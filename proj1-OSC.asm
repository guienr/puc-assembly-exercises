...
    MOV AH, 09h                ; Exibe a mensagem de modos de jogo
    LEA DX, MSG_MODO           ; Carrega o endereço da mensagem
    INT 21h            
    LEA DX, MSG_E1             ; Exibe opção 1
    INT 21h      
    LEA DX, MSG_E2             ; Exibe opção 2
    INT 21h    
    LEA DX, MSG_ESCOLHA        ; Exibe o prompt de escolha
    INT 21h
    
    MOV AH, 01h                ; Função para ler um caractere
    INT 21h                    ; O caractere lido vai para AL
    
...
    LEA DX, MSG_MV             ; "Modo de jogo inválido" 
    INT 21h
...
    MOV AH, 09h                ; Exibe a mensagem de erro
    LEA DX, MSG3               ; "Essa posição já foi ocupada"
    INT 21h
...
    MOV AH, 09h                ; Exibe a mensagem de empate
    LEA DX, MSG6               ; "Empate!"
    INT 21h
...
    MOV DL, 13                 ; Caractere CR
    INT 21h
    MOV DL, 10                 ; Caractere LF
    INT 21h
...
    MOV DL, 20h                ; Move o caractere de Espaço para DL
...
    MOV AH, 09h                ; Função que exibe uma string para o jogador escolher a posição
    LEA DX, MSG1
    INT 21h

    MOV AH, 01h                ; Lê a entrada do usuário para a jogada
    INT 21h                    ; Caractere lido em AL
...
    MOV AH, 09h                ; Função que exibe uma string
    LEA DX, MSG_BOT            ; Exibe mensagem do Bot pensando
    INT 21h
    
...
    MOV AH, 09h                ; Função que exibe a mensagem de vitória
    LEA DX, MSG4
    INT 21h
    CALL IMPRIMIRM             ; Imprime o tabuleiro final
